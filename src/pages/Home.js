        ...
        <div id="home">
            <div id="mainContainer">
                            ...
                            <div className="hidden" id="sevenDayDisplay">
                                <div className="eachDayin7Days">
                                    ...
                                    <div className="rainChance">
                                        ...
                                        <div className="rainDropImg"><img src={rainDropImg} /></div>
                                        <div>54%</div>
                                    </div>
                                    <div className="generalWeather"><img src={sunImg} /></div>
                                ...
                                <div className="eachDayin7Days">
                                    ...
                                    <div className="generalWeather"><img src={cloudyNoSunImg} /></div>
                                    <div className="lowTempContainer">Lowest:
                                        <div className="lowestTemp">55</div>
                                        <span>&#176;</span>
                                        <div className="fahrenheitDisplay">F</div>
                                ...
                                <div className="eachDayin7Days">
                                    ...
                                    <div className="generalWeather"><img src={cloudyWithSunImg} /></div>
                                    <div className="lowTempContainer">Lowest:
                                        <div className="lowestTemp">55</div>
                                        <span>&#176;</span>
                                        <div className="fahrenheitDisplay">F</div>
                                ...
                                <div className="eachDayin7Days">
                                    ...
                                    <div className="generalWeather"><img src={cloudyRainImg} /></div>
                                    <div className="lowTempContainer">Lowest:
                                        <div className="lowestTemp">55</div>
                                        <span>&#176;</span>
                                        <div className="fahrenheitDisplay">F</div>
                            ...
                            <div id="monthlyDisplay">
                                <div className="monthRows">
                                    <div className="eachDayInRow">30
                                        <div className="holdClimatePic"><img src={sunImg} /></div>
                                    </div>
                                    <div className="eachDayInRow">31
                                        <div className="holdClimatePic"><img src={cloudyWithSunImg} /></div>
                                    </div>
                                    <div className="eachDayInRow">1
                                        <div className="holdClimatePic"><img src={cloudyNoSunImg} /></div>
                                    </div>
                                    <div className="eachDayInRow">2
                                        <div className="holdClimatePic"><img src={cloudyRainImg} /></div>
                                    </div>
                ...
                <div id="rightContainer">
                    ...
                    <div id="todayInfo">
                        <div id="todayDate">
                            <div id="imgCurrentWeather"><img src={sunImg} /></div>
                            <div id="holdText">
                                <h2>Today</h2>
